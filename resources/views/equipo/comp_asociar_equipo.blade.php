<div>
    <a class="btn btn-primary create" data-toggle="collapse" href="#collapse_equipo_nuevo">Agregar Equipo</a>
        ...
        <div class="" id="contenedor_nuevo_torneo">
            <div class="bg-white resaltar">
                ...
                <div class="alert bg-info">
                    ...
                    <p>Si el equipo no se encuentra registrado, puede registrar un <a class="cl-azul manita edit " data-toggle="modal" data-target="#myModal" data-link="/equipo/create">Nuevo Equipo</a></p>
                    <hr>
                    {{Form::open()}}
                        @include('otros.selectEquipo')
                        <a class="save_ajax btn btn-primary pull-right" data-link="/torneo/{{$torneo->id}}/addEquipo">Añadir</a>
                    {{Form::close()}}
                </div>
            </div>
        </div>
